...
class TestShell:
    """Wrapper Class for ReservistenCoinTestFramework.

    The TestShell class extends the ReservistenCoinTestFramework
    ...
    class __TestShell(ReservistenCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ReservistenCoinTestFramework child class.
            self.num_nodes = 1
