...
class TxDownloadTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new reservistencoind instances, as setting mocktimes has long-term effects on when
