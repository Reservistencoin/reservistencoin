...
"""Verify that starting reservistencoin with -h works as expected."""

from test_framework.test_framework import ReservistenCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reservistencoin with -h for help text")
        ...
        self.log.info("Start reservistencoin with -version for version information")
        ...
        self.log.info("Start reservistencoind with -fakearg to make sure it does not start")
