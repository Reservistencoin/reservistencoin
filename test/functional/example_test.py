...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ReservistenCoinTestFramework
    pass


class ExampleTest(ReservistenCoinTestFramework):
    # Each functional test is a subclass of the ReservistenCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ReservistenCoinTestFramework class so other tests can use it."""
