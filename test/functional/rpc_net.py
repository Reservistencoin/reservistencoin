...
class NetTest(ReservistenCoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=24878)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 24878)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=24878), {"success": False})
