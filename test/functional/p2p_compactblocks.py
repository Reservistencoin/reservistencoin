...
# TestP2PConn: A peer we use to send messages to reservistencoind, and store responses.
...
class CompactBlocksTest(ReservistenCoinTestFramework):
    ...
    # This test actually causes reservistencoind to (reasonably!) disconnect us, so do this last.
    ...
    # reservistencoind's choice of nonce.
    ...
    # Test that reservistencoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for reservistencoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # reservistencoind will not send blocktxn responses for blocks whose height is
