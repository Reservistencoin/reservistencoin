...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/reservistencoin/reservistencoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/reservistencoin/reservistencoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
