...
By default, reservistencoind will dump mempool on shutdown and
...
class MempoolPersistTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent reservistencoind from writing mempool.dat to disk. Verify that `savemempool` fails")
