...
class TxnMallTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 RVC:
        ...
        # First: use raw transaction API to send 1240 RVC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RVC coin each
        ...
        # Node0's balance should be starting balance, plus 50RVC for another
        ...
        # Node0's total balance should be starting balance, plus 100RVC for
