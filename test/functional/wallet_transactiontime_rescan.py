...
class TransactionTimeRescanTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine RVC and create transactions
        ...
        # generate some rvc to create transactions and check blockcount
        ...
        # send 10 rvc to user's first watch-only address
        self.log.info('Send 10 rvc to user')
        ...
        # send 5 rvc to our second watch-only address
        self.log.info('Send 5 rvc to user')
        ...
        # send 1 rvc to our third watch-only address
        self.log.info('Send 1 rvc to user')
