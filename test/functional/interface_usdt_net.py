...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/reservistencoin/reservistencoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our reservistencoind node")
