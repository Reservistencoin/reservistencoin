...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/reservistencoin/reservistencoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(ReservistenCoinTestFramework):
