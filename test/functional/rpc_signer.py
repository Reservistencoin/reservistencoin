...
Verify that a reservistencoind node can use an external signer command.
...
class RPCSignerTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart reservistencoind with -signer=<cmd>',
