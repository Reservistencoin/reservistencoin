...
"""
Test starting reservistencoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that reservistencoind has bound on "::1" (for RPC) and "::" (for P2P).
