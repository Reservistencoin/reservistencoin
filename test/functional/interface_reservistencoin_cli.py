...
# The block reward of coinbaseoutput.nValue (50) RVC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 RVC/block.
...
class TestReservistenCoinCli(ReservistenCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `reservistencoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and reservistencoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and reservistencoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (RVC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (RVC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 RVC) to the default wallet.
            ...
            # Test reservistencoin-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test reservistencoin-cli -generate with -rpcwallet in multiwallet mode.
