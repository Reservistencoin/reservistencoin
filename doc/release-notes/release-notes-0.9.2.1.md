ReservistenCoin Core version 0.9.2.1 is now available from:

  https://reservistencoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RVC to 0.01 RVC
...
- Fix "Start reservistencoin on system login"
