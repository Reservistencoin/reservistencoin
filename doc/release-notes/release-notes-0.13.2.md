ReservistenCoin Core version 0.13.2 is now available from:

  <https://reservistencoin.org/bin/reservistencoin-core-0.13.2/>
...
- #8908 `4a974b2` Update reservistencoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow reservistencoin-tx to create v2 transactions (rvcdrak)
