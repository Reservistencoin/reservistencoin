...
ReservistenCoin Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/reservistencoin-core-0.19.1/>
...
From ReservistenCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as ReservistenCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, ReservistenCoin Core does not yet change appearance when
...
- #17488 fix "reservistencoind already running" warnings on macOS (fanquake)
