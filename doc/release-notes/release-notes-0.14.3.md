ReservistenCoin Core version *0.14.3* is now available from:

  <https://reservistencoin.org/bin/reservistencoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/reservistencoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
