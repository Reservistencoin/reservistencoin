ReservistenCoin Core version 0.9.4 is now available from:

  https://reservistencoin.org/bin/0.9.4/
...
this update is incompatible with the ReservistenCoin system and could lead to consensus
forks.

ReservistenCoin Core released binaries from https://reservistencoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~reservistencoin/+archive/ubuntu/reservistencoin
- A third-party or self-compiled ReservistenCoin Core

upgrade to ReservistenCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
