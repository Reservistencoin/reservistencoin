ReservistenCoin Core version 0.10.3 is now available from:

  <https://reservistencoin.org/bin/reservistencoin-core-0.10.3/>
...
(see https://github.com/reservistencoin/reservistencoin/pull/6793, as well as the 0.11.0
