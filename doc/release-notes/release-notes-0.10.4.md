ReservistenCoin Core version 0.10.4 is now available from:

  <https://reservistencoin.org/bin/reservistencoin-core-0.10.4/>
...
- #6953 `43c2789` Split reservistencoin-tx into its own package
- #6953 `dfe0d4d` Include reservistencoin-tx binary on Debian/Ubuntu
