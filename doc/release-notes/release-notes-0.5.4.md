ReservistenCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/reservistencoin/files/ReservistenCoin/reservistencoin-0.5.4/
...
http://gitorious.org/reservistencoin/reservistencoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ReservistenCoin-Qt notifications under Growl 1.3.
Increase required age of ReservistenCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxReservistenCoin properly when installing ReservistenCoin-Qt over it. (Windows)
