Download URL: https://sourceforge.net/projects/reservistencoin/files/ReservistenCoin/reservistencoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RVC fee schedule (users still pay 0.01 RVC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #reservistencoin00 - #reservistencoin99
