ReservistenCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/reservistencoin/files/ReservistenCoin/reservistencoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ReservistenCoin
...
New/changed settings (command-line or reservistencoin.conf file)
--------------------------------------------------------
