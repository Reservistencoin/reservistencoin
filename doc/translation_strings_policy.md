...
This document provides guidelines for internationalization of the ReservistenCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `reservistencoin_en.ts` remains unchanged.
