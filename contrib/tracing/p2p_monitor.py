...
""" Interactive reservistencoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for ReservistenCoin Core can enable. It uses BCC
...
def main(reservistencoind_path):
    ...
    reservistencoind_with_usdts.enable_probe(
