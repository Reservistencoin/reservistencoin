...
"""Example logging ReservistenCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/reservistencoind
...
def main(reservistencoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[reservistencoind_with_usdts])
