...
(define* (make-reservistencoin-cross-toolchain target
                                       #:key
...
desirable for building ReservistenCoin Core release binaries."
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-reservistencoin-cross-toolchain target)))
