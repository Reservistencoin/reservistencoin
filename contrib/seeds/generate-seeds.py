...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef RESERVISTENCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define RESERVISTENCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the reservistencoin network\n')
    ...
    g.write('#endif // RESERVISTENCOIN_CHAINPARAMSSEEDS_H\n')
