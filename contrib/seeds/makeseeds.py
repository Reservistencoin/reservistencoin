...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of reservistencoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple reservistencoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple reservistencoin ports', file=sys.stderr)
