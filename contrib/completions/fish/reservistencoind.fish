...
complete --command reservistencoind --no-files

# Extract options
function __fish_reservistencoind_get_options
...
complete \
    --command reservistencoind \
    --arguments "(__fish_reservistencoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command reservistencoind \
...
complete \
    --command reservistencoind \
    --arguments "(__fish_reservistencoind_get_options --nofiles)"
