...
complete --command reservistencoin-qt --no-files

# Extract options
function __fish_reservistencoinqt_get_options
...
complete \
    --command reservistencoin-qt \
    --arguments "(__fish_reservistencoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c reservistencoin-qt \
...
complete \
    --command reservistencoin-qt \
    --arguments "(__fish_reservistencoinqt_get_options --nofiles)"
