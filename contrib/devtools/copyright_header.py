...
EXCLUDE = [
    # auto generated:
    'src/qt/reservistencoinstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The ReservistenCoin Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a reservistencoin source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The ReservistenCoin Core developers'
...
Arguments:
    <file> - A source file in the reservistencoin repository.
"""
