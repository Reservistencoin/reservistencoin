...
#ifndef RESERVISTENCOIN_UTIL_SYSCALL_SANDBOX_H
#define RESERVISTENCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during reservistencoind initialization if ReservistenCoin Core was compiled
...
#endif // RESERVISTENCOIN_UTIL_SYSCALL_SANDBOX_H
