...
#ifndef RESERVISTENCOIN_UTIL_MESSAGE_H
#define RESERVISTENCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's reservistencoin address, it must refer to a public key.
...
#endif // RESERVISTENCOIN_UTIL_MESSAGE_H
