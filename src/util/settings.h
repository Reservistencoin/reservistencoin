...
#ifndef RESERVISTENCOIN_UTIL_SETTINGS_H
#define RESERVISTENCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/reservistencoin/reservistencoin/pull/15934/files#r337691812)
...
#endif // RESERVISTENCOIN_UTIL_SETTINGS_H
