...
#ifndef RESERVISTENCOIN_WALLET_WALLETUTIL_H
#define RESERVISTENCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! reservistencoin from opening the wallet, thinking it was newly created, and
...
#endif // RESERVISTENCOIN_WALLET_WALLETUTIL_H
