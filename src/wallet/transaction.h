...
#ifndef RESERVISTENCOIN_WALLET_TRANSACTION_H
#define RESERVISTENCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this reservistencoin node, and set to 0 for transactions that were created
...
#endif // RESERVISTENCOIN_WALLET_TRANSACTION_H
