...
#ifndef RESERVISTENCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define RESERVISTENCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // RESERVISTENCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
