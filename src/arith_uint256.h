...
#ifndef RESERVISTENCOIN_ARITH_UINT256_H
#define RESERVISTENCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * ReservistenCoin only uses this "compact" format for encoding difficulty
...
#endif // RESERVISTENCOIN_ARITH_UINT256_H
