...
#ifndef RESERVISTENCOIN_HEADERSSYNC_H
#define RESERVISTENCOIN_HEADERSSYNC_H
 ...
 *
 * The ReservistenCoin protocol does not offer an easy way to determine the work on a
...
#endif // RESERVISTENCOIN_HEADERSSYNC_H
