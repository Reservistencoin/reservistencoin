...
#ifndef RESERVISTENCOIN_COMPAT_ASSUMPTIONS_H
#define RESERVISTENCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "ReservistenCoin cannot be compiled without assertions."
#endif
...
#endif // RESERVISTENCOIN_COMPAT_ASSUMPTIONS_H
