...
#ifndef RESERVISTENCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define RESERVISTENCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // RESERVISTENCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
