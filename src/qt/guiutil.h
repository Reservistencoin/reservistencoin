...
#ifndef RESERVISTENCOIN_QT_GUIUTIL_H
#define RESERVISTENCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the ReservistenCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "reservistencoin:" URI into recipient object, return true on successful parsing
...
#endif // RESERVISTENCOIN_QT_GUIUTIL_H
