...
#ifndef RESERVISTENCOIN_QT_WALLETMODEL_H
#define RESERVISTENCOIN_QT_WALLETMODEL_H
...
/** Interface to ReservistenCoin wallet from Qt view code. */
...
#endif // RESERVISTENCOIN_QT_WALLETMODEL_H
