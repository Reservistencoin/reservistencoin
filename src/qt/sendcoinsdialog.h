...
#ifndef RESERVISTENCOIN_QT_SENDCOINSDIALOG_H
#define RESERVISTENCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending reservistencoins */
...
#endif // RESERVISTENCOIN_QT_SENDCOINSDIALOG_H
