...
//! Entry point for ReservistenCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ReservistenCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ReservistenCoinGUI tests.
void AppTests::guiTests(ReservistenCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ReservistenCoinGUI::consoleShown, this, &AppTests::consoleTests);
