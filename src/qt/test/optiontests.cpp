...
{
    // Test regression https://github.com/reservistencoin/reservistencoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/reservistencoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/reservistencoin-core/gui/pull/568.
    // With fListen=false in ~/.config/ReservistenCoin/ReservistenCoin-Qt.conf and all else left as default,
    // reservistencoin-qt should set both -listen and -listenonion to false and start successfully.
