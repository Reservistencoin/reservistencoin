...
#ifndef RESERVISTENCOIN_QT_CLIENTMODEL_H
#define RESERVISTENCOIN_QT_CLIENTMODEL_H
...
/** Model for ReservistenCoin network client. */
...
#endif // RESERVISTENCOIN_QT_CLIENTMODEL_H
