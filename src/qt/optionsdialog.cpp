      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->reservistencoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->reservistencoinAtStartup);
    ...
    ui->reservistencoinAtStartup->setToolTip(ui->reservistencoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->reservistencoinAtStartup->setText(ui->reservistencoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openReservistenCoinConfButton->setToolTip(ui->openReservistenCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ReservistenCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->reservistencoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSRVControls);
...
void OptionsDialog::on_openReservistenCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openReservistenCoinConf())
