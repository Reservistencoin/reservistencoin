...
#ifndef RESERVISTENCOIN_RPC_PROTOCOL_H
#define RESERVISTENCOIN_RPC_PROTOCOL_H
...
//! ReservistenCoin RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in reservistencoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< ReservistenCoin is not connected
...
#endif // RESERVISTENCOIN_RPC_PROTOCOL_H
