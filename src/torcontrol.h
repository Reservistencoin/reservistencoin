 ...
 */
#ifndef RESERVISTENCOIN_TORCONTROL_H
#define RESERVISTENCOIN_TORCONTROL_H
...
/****** ReservistenCoin specific TorController implementation ********/
...
#endif // RESERVISTENCOIN_TORCONTROL_H
