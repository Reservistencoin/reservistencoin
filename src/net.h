...
#ifndef RESERVISTENCOIN_NET_H
#define RESERVISTENCOIN_NET_H
...
public:
     ...
     * @see https://github.com/reservistencoin/reservistencoin/issues/21744 for details.
     */
