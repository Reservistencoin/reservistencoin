...
#ifndef RESERVISTENCOIN_INTERFACES_NODE_H
#define RESERVISTENCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a reservistencoin node (reservistencoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or reservistencoin.conf.
...
#endif // RESERVISTENCOIN_INTERFACES_NODE_H
