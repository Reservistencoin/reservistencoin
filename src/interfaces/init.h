...
#ifndef RESERVISTENCOIN_INTERFACES_INIT_H
#define RESERVISTENCOIN_INTERFACES_INIT_H
...
//! (reservistencoin-gui, reservistencoin-node, reservistencoin-wallet, reservistencoind, reservistencoin-qt) and each
...
#endif // RESERVISTENCOIN_INTERFACES_INIT_H
