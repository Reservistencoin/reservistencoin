...
#ifndef RESERVISTENCOIN_TEST_SCRIPTNUM10_H
#define RESERVISTENCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ReservistenCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // RESERVISTENCOIN_TEST_SCRIPTNUM10_H
