...
{
    BOOST_CHECK(TestSplitHost("www.reservistencoincore.org", "www.reservistencoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.reservistencoincore.org]", "www.reservistencoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.reservistencoincore.org:80", "www.reservistencoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.reservistencoincore.org]:80", "www.reservistencoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:24878", "127.0.0.1", 24878));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:24878", "127.0.0.1", 24878));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:24878", "::ffff:127.0.0.1", 24878));
    BOOST_CHECK(TestSplitHost("[::]:24878", "::", 24878));
    BOOST_CHECK(TestSplitHost("::24878", "::24878", 0));
    BOOST_CHECK(TestSplitHost(":24878", "", 24878));
    BOOST_CHECK(TestSplitHost("[]:24878", "", 24878));
    ...
    BOOST_CHECK(TestSplitHost("www.reservistencoincore.org:65536", "www.reservistencoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.reservistencoincore.org:0", "www.reservistencoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.reservistencoincore.org:", "www.reservistencoincore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:24878", "127.0.0.1:24878"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:24878", "[::]:24878"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
