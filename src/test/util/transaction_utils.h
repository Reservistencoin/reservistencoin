...
#ifndef RESERVISTENCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define RESERVISTENCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // RESERVISTENCOIN_TEST_UTIL_TRANSACTION_UTILS_H
