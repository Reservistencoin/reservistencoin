...
#ifndef RESERVISTENCOIN_SCRIPT_MINISCRIPT_H
#define RESERVISTENCOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a reservistencoin script
...
#endif // RESERVISTENCOIN_SCRIPT_MINISCRIPT_H
