...
#ifndef RESERVISTENCOIN_SCRIPT_STANDARD_H
#define RESERVISTENCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a reservistencoin address
 */
...
/**
 * Generate a ReservistenCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // RESERVISTENCOIN_SCRIPT_STANDARD_H
