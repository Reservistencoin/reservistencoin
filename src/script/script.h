...
#ifndef RESERVISTENCOIN_SCRIPT_SCRIPT_H
#define RESERVISTENCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, ReservistenCoin always counted CHECKMULTISIGs
...
#endif // RESERVISTENCOIN_SCRIPT_SCRIPT_H
