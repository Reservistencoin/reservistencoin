...
#ifndef RESERVISTENCOIN_IPC_PROCESS_H
#define RESERVISTENCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning reservistencoin processes and serving requests
...
#endif // RESERVISTENCOIN_IPC_PROCESS_H
