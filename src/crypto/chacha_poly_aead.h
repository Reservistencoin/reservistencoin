...
#ifndef RESERVISTENCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define RESERVISTENCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@reservistencoin.
 *
 ...
 *
 * The chacha20-poly1305@reservistencoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@reservistencoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@reservistencoin are relatively fast in
...
#endif // RESERVISTENCOIN_CRYPTO_CHACHA_POLY_AEAD_H
