...
#ifndef RESERVISTENCOIN_EXTERNAL_SIGNER_H
#define RESERVISTENCOIN_EXTERNAL_SIGNER_H
...
private:
    ...
    //! ReservistenCoin mainnet, testnet, etc
    std::string m_chain;
...
#endif // RESERVISTENCOIN_EXTERNAL_SIGNER_H
