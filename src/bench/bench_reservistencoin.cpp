...
int main(int argc, char** argv)
{
    ...
    if (HelpRequested(argsman)) {
        std::cout << "Usage:  bench_reservistencoin [options]\n"
                     "\n"
                  << argsman.GetHelpMessage()
                  << "Description:\n"
                     "\n"
                     "  bench_reservistencoin executes microbenchmarks. The quality of the benchmark results\n"
                     ...
                     "\n"
                     "  * bench_reservistencoin uses nanobench [3] for which there is extensive\n"
                     ...
                     "\n"
                     "    NANOBENCH_ENDLESS=MuHash ./bench_reservistencoin -filter=MuHash\n"
                     "\n"
                     ...
                     "\n"
                     "    NANOBENCH_SUPPRESS_WARNINGS=1 ./bench_reservistencoin\n"
                     "\n"
                     "Notes:\n"
                     "\n"
                     "  1. pyperf\n"
